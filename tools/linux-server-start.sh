...
SERVER_SCRIPT=/home/ue4/project/EOSDemoServer.sh
...
main() {
    ...
    $SERVER_SCRIPT "$MAP_NAME"?game="$GAMEMODE_NAME" -server -log -epicapp=Server -MAPNAME="$MAP_NAME" -GAMEMODE="$GAMEMODE_NAME"
}
