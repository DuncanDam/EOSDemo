...
#define SETTING_GROUP FName(TEXT("GROUP"))
#define SETTING_GROUP_DEFAULT FString("EOSSession")
 ...
 */
UCLASS()
class EOSDEMO_API AEOSGameSession : public AGameSession
{
	GENERATED_BODY()
...
protected:
	...
	void CreateSession(FString GameMap, FString GameMode);
